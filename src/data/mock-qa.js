export default [
  {
    id: "q1",
    text: "What is the primary purpose of **Babel** in a modern React project?",
    answers: [
      "To transpile modern JavaScript (ES6+) into backward-compatible JavaScript",
      "To manage the component state",
      "To bundle modules for production",
